...
export function seed() {
  ...
  return {
    ...
    leases: [
      { id: 'lease-1', owner_id: DEMO_USER.id, property_id: 'prop-1', tenant_name: 'Bright Coffee Co.', tenant_email: 'sam@brightcoffee.example', tenant_contact_name: 'Sam Rivera', square_footage: 2000, base_rent: 60000, lease_start: iso(Y - 2, 1, 1), lease_termination_date: iso(Y + 1, 12, 31), lease_terms: 'NNN lease, 5 year term.', share_override_pct: null, roof_responsible: true, no_renewal_option: false, lease_text: leaseText['lease-1'], source: 'manual', extraction_status: 'reviewed' },
      { id: 'lease-2', owner_id: DEMO_USER.id, property_id: 'prop-1', tenant_name: 'City Dental', tenant_email: 'billing@citydental.example', tenant_email_2: 'dana.lee@citydental.example', tenant_contact_name: 'Dana Lee', square_footage: 3000, base_rent: 84000, lease_start: iso(Y - 1, 6, 1), lease_termination_date: iso(2026, 5, 31), lease_terms: 'Includes one 5-year renewal option.', share_override_pct: null, roof_responsible: false, no_renewal_option: false, lease_text: leaseText['lease-2'], source: 'manual', extraction_status: 'reviewed' },
      ...
      { id: 'lease-3', owner_id: DEMO_USER.id, property_id: 'prop-2', tenant_name: 'Northwind Books', tenant_email: 'accounts@northwindbooks.example', tenant_contact_name: 'Jordan Pak', square_footage: 5000, base_rent: 125000, lease_start: iso(Y - 3, 1, 1), lease_termination_date: soon, lease_terms: 'Tenant pays 40% of CAM by agreement.', share_override_pct: 0.4, roof_responsible: false, no_renewal_option: true, lease_text: leaseText['lease-3'], source: 'ai_extracted', extraction_status: 'reviewed', ai_confidence: { square_footage: 0.99, base_rent: 0.97, lease_termination_date: 0.72, lease_terms: 0.6 } },
    ],
    rent_escalations: [
