...
export const DASHBOARD_WIDGETS = [
  ...
  { key: 'ar',          label: 'Outstanding (receivables)', hint: 'What tenants still owe you, and how much is overdue. Hides both the Overview card and the receivables section on each property’s Financials page.' },
